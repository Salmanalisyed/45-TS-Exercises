...
let guestwhocannotmakeit: string = "Capt Tayyab Hussain Shah"
...
let newGuest: string = "Syed Ali Abbas"
let indexOfguestwhocannotmakeit: number = guestList.indexOf(guestwhocannotmakeit)
