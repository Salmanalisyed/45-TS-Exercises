...
const stringEqulity: string = 'Classic view';
const stringInequality: string = 'classic view';
...
const word1: string = 'TRY AGAIN';
const word2: string = 'try again';
...
const vehicle: string[] = ['car', 'truck', 'bus', 'van'];
...
const birds: string[] = ['Eagle', 'crow', 'chicken', 'duck'];
